...
# Hostinger VPS 전체 스택 설정 스크립트 (백엔드 + 프론트엔드)

echo "🚀 Hostinger VPS 전체 스택 설정 시작..."
...
# 프로젝트 디렉토리 생성
echo "📁 프로젝트 디렉토리 생성 중..."
sudo mkdir -p /var/www/ta-go-backend
sudo mkdir -p /var/www/ta-go
sudo chown $USER:$USER /var/www/ta-go-backend
...
echo "✅ 전체 스택 초기 설정 완료!"
echo "📋 다음 단계:"
echo "1. 백엔드 저장소 클론: cd /var/www/ta-go-backend && git clone [백엔드-저장소-URL] ."
